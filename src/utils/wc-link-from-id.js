import { displayWaterNetworkFeaturesInMapViewport, getHydroNode, getWatercourseLink } from "../utils/water-network-data";
...
const getStartNodeCoords = async (watercourseLink) => {
  return getHydroNode(watercourseLink.properties.startNode)
    .then((hydroNode) => (hydroNode.geometry.coordinates))
}
